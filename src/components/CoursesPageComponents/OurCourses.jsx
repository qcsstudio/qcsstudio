...
const OurCourses = () => {
    return (
        <div className='relative h-[600] flex justify-center items-center' >
            <Image className='absolute top-20 left-36 hidden md:hidden lg:flex' src='/images/recentsblogsbg3.png' height={100} width={100}></Image>
            <Image className='absolute top-8 right-20 hidden md:flex lg:flex' src='/images/groupkite (1).png' height={200} width={200}></Image>
            <Image className='absolute bottom-20 left-20 hidden lg:block' src='/images/bubles2.png' height={300} width={300}></Image>
            <Image className='absolute bottom-20 right-32 hidden md:hidden lg:flex ' src='/images/brush.png' height={200} width={200}></Image>
            <Image className='absolute top-20 left-80 hidden md:hidden lg:flex' src='/images/Group (3).png' height={100} width={100}></Image>
            <Image className='absolute top-20 right-80 hidden md:hidden lg:flex' src='/images/AI.png' height={70} width={70}></Image>
            <Image className='absolute bottom-20 left-80 hidden md:hidden lg:flex' src='/images/speaker.png' height={100} width={100}></Image>
            <Image className='absolute bottom-8 ' src='/images/groupkite (2).png' height={70} width={70}></Image>
