...
const Success = () => {
    return (
        <div>
            <div className=" bg-[url('/images/bgSuccess.jpg')] bg-cover bg-center bg-no-repeat h-[100vh] lg:h-[80vh] w-full flex flex-col justify-start items-start gap-10">
                <div className='flex flex-col justify-start m-3 pt-14 lg:pt-0 lg:m-24 gap-3'>
                    ...
                    <p className=' tracking-wider lg:tracking-normal lg:w-[30vw] text-white text-[16px]'>
                ...
                <div className='flex flex-col lg:flex-row gap-2 m-2 -mt-4 lg:m-24 lg:-mt-10 '>
                    <div className='flex flex-col gap-2 '>
                        ...
                        <p className='text-white lg:w-auto mb-5'>
                    ...
                    <div className='flex flex-col gap-1 lg:gap-2'>
                        ...
                        <p className='text-white lg:w-auto'>
