              ...
              <div className="flex flex-col  text-center md:text-left">
                {multipleBlogData[0]?.thumbnail &&
                  ...
                  <Image
                    ...
                    alt="Head"
                  />}
                  {console.log("full data: ",multipleBlogData )}
                ...
                <div
                  className="text-[#0E2D5B] font-normal leading-[20px] text-xs sm:text-sm md:text-base"
                  dangerouslySetInnerHTML={{
                    __html: multipleBlogData[0]?.description
                      ? multipleBlogData[0].description.substring(0, 10)
                      : "",
                  }}
                ></div>
