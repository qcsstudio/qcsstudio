    ...
    return (
        <div className='mentor relative w-full h-[100vh] flex justify-center items-center'>
            ...
            <div className='absolute left-[8%] top-[75%] transform -translate-y-1/2 flex flex-col gap-10'>
                <Image height={50} width={50} alt='mentor-left-1' src={mbg4.src} className='self-start rounded-2xl ml-[450%]' />
                <Image height={80} width={80} alt='mentor-left-2' src={mbg1.src} className='self-center mt-[-20px] ml-[450%] rounded-2xl ' />
                <Image height={50} width={50} alt='mentor-left-3' src={mbg2.src} className='self-start mt-0 rounded-2xl ml-[450%]' />
            </div>
            ...
            <div className='flex flex-col justify-center items-center text-center gap-5'>
                ...
                <p className='w-[160%]'>
                    Our instructors aren't just teachers; they're seasoned professionals who bring years of industry experience to the classroom.
                </p>
                <span className='-m-8 -mt-3'>
                    They'll guide you, inspire you, and help you navigate the challenges of the tech world.
                </span>
            ...
            <div className='absolute right-40 top-[70%] transform -translate-y-1/2 flex flex-col gap-16'>
                <Image height={80} width={80} alt='mentor-right-1' src={mbg6.src} className='self-end rounded-2xl mr-[350%]' />
                <Image height={50} width={50} alt='mentor-right-2' src={mbg5.src} className='self-center mt-[-20px] mr-[350%] rounded-2xl' />
                <Image height={80} width={80} alt='mentor-right-3' src={mbg3.src} className='self-end rounded-2xl mr-[350%]' />
            </div>
        </div>
    );
};
